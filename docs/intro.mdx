...
<img src="/img/intro/invite-profile.png"></img>

Select the server you want to invite it to, and click on **Continue**

<img style={{ height: "500px" }} src="/img/intro/select-server.png"></img>

Make sure it has all these permissions, and click on **Authorize**

<img style={{ height: "600px" }} src="/img/intro/grant-perms.png"></img>
...
<img style={{ height: "150px" }} src="/img/intro/set-aff-code.png"></img>
<img style={{ height: "150px" }} src="/img/intro/conf-aff.png"></img>
...
<img style={{ height: "200px" }} src="/img/intro/set-mode.png"></img>
<img style={{ height: "150px" }} src="/img/intro/conf-mode.png"></img>
...
<img style={{ height: "120px" }} src="/img/intro/set-enabled.png"></img>
<img style={{ height: "150px" }} src="/img/intro/conf-enabled.png"></img>

## You're ready to go!

The bot is now set up and ready to replace links! Here is an example:

<img style={{ height: "250px" }} src="/img/intro/replace-example.png"></img>